...
def create_selections( file ):
    ...
    selections["DoubleCascade"] = selections["RecoETot>60TeV"] & ( file['variables']["FinalEventClass"] == 2 )
    selections["SingleCascade"] = selections["RecoETot>60TeV"] & ( file['variables']["FinalEventClass"] == 1.0 )

    selections["DoubleCascadeEvtGen"] = selections["RecoETot>60TeV"] & ( file['variables']["FinalEventClass_evtgen"] == 2 )
